...
export const ImageProvider = ({ children }) => {
  ...
  const [original,setOriginal] = useState({
    brand:'roadster',name:'pure neck cotton t-shirt',price:
    '399',
    discount:50,
    img: 'https://assets.myntassets.com/f_webp,dpr_2.8,q_60,w_210,c_limit,fl_progressive/assets/images/12193826/2020/10/13/e5880ee7-80af-4405-ae9f-7760b22a34621602571369433-Roadster-Women-Tshirts-1601602571367968-1.jpg'
  }
  )
